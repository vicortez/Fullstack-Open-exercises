...
const someService = { someFunc }

someService.someFunc() // <- should highlight
someFunc()
const someOtherFunc = () => someFunc()
someOtherFunc() // <- should highlight

// this is already correctly highlighted
